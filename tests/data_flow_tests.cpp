...
// 1. calculateTotalCost Data Flow Tests
...
// 2. calculateRemainingFunds Data Flow Tests
...
// 3. calculateFundsDuration Data Flow Tests
TEST(CalculateFundsDuration, BranchCoverage) {
    ...
    // TC8: rremainingFunds <= 0 in the first loop not reachable
    ...
    // TC10: hoursToday < 24.0 (partial day), loop ends
    EXPECT_NEAR(9.5, calculateFundsDuration(1000.0, 1.0, 100, 0.5), EPSILON);

}

// 4. calculateTotalCostMultipleGpus Data Flow Tests
...
// 5. calculateFundsDurationMultipleGpus Data Flow Tests
